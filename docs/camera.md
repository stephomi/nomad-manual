...
## Controlling the camera {#control}
...
### ![](/icons/tool_view.webp) Add View {#add}
Create a new camera based on the current view.

### ![](/icons/camera.webp) Icons {#icons-test}
...
### Orthographic snap {#orthographic}
