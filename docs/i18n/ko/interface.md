...
### 하단 단축키 추가... {#add-shortcuts-bottom}
...
#### ![](/icons/more.webp) 바인딩 {#bindings-list}
...
#### ![](/icons/list.webp) 순서 {#order}

단축키 목록을 표시합니다. 길게 누른 후 드래그하여 단축키의 순서를 변경할 수 있습니다.

#### ![](/icons/reset.webp) 초기화 {#reset}

Reset은 하단 툴바를 기본 설정으로 되돌립니다.

### 창 단축키 추가... + {#add-shortcuts-window}
...
#### ![](/icons/resize_bottom_right.webp) UI 크기 조절 모서리 {#ui-resize-corner}
...
#### 고대비 버튼 {#high-contrast-button}
활성화된 버튼이 더 잘 보이도록 하는 대체 스타일입니다. Auto로 설정하면, 활성/비활성 UI 색상 대비가 낮을 때 Nomad가 이 모드를 사용합니다.

#### 색상 위젯/기본 색상 {#color-widgetcolor-base}
인터페이스에서 사용되는 기본 색상입니다.

#### 투명 패널, 색상 패널, 블러 강도 {#transparent-panel-color-panel-blur-strength}
...
### 세로 간격(왼쪽) {#vertical-spacing-left}
왼쪽 툴바 내 요소 간의 세로 간격입니다.

----

### 가장자리 오프셋 {#edge-offset}
...
### 마스크 <-> SelMask 전환 {#toggle-mask-selmask}
...
### ![](/icons/finger3.webp) 세 손가락 {#three-fingers}
...
### ![](/icons/fingerprint.webp) 기록 2/3 {#history-23}
...
### ![](/icons/more.webp) 컨텍스트 메뉴 {#context-menu}
...
## iOS ⌘ 키보드 단축키 표시 {#ios-keyboard-shortcuts-display}
