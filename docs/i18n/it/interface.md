# ![](/icons/sliders.webp) Menú de interfaz {#interface-menu}
...
#### ![](/icons/resize_bottom_right.webp) Esquina de cambio de tamaño de la interfaz {#ui-resize-corner}
...
#### Filas: Automático (>1) {#rows-auto-1}
...
#### Widget de color/Base de color {#color-widgetcolor-base}
...
----
### Ventana de ayuda al pasar el cursor {#help-popup-on-hover}
...
### Escala de la fuente {#font-scale}
Scala dei font.
...
### Doble toque de lápiz -> Asignaciones {#pencil-tap}
