# ![](/icons/material.webp) Vật liệu {#material}
...
## Các loại vật liệu {#material-types}
...
### ![](/icons/material_blending.webp) Hòa trộn {#blending}
...
### ![](/icons/material_additive.webp) Cộng dồn {#additive}
...
### ![](/icons/material_refraction.webp) Khúc xạ {#refraction}
...
### ![](/icons/material_shadow_catcher.webp) Bắt bóng {#shadow-catcher}
...
### Luôn không đổ sáng (unlit) {#always-unlit}
...
### Đảo chiều mặt (Inverse culling) {#inverse-culling}
...
### Tùy chọn bảng kết cấu {#texture-panel-options}
...
### Phép chiếu (Projection) {#projection}
...
### Ba mặt phẳng (Triplanar) {#triplanar}
...
#### Lặp-Y (Tiling-Y) {#tiling-y}
Giống Tiling-X, nhưng cho trục Y.

### Biến đổi (Transform) {#transform}
...
#### Tịnh tiến (Translation) {#translation}
Độ lệch X và Y của texture

#### Xoay (Rotation) {#rotation}
