# ![](/icons/manual.webp) Mẹo {#tips}

[[toc]]

## Cách bắt đầu một mẫu {#how-to-start-a-model}
...
### Điêu khắc trên khối cầu, đa phân giải {#sculpt-on-sphere-multires}
...
### Dùng nhiều đối tượng {#use-multiple-objects}
...
### Dùng các ứng dụng khác {#use-other-apps}
...
### Dùng các preset tích hợp sẵn {#use-the-built-in-presets}
...
### Dùng mẫu (model) trực tuyến {#use-online-models}
...
### Tại sao dùng facegroups? {#why-facegroups}
...
### Tạo và chỉnh sửa facegroups {#creating-and-editing-facegroups}
...
### Lọc bằng các công cụ khác {#filter-with-other-tools}
...
### Làm dịu và làm mượt biên facegroup {#relax-and-smooth-facegroup-borders}
...
### Hệ điều hành ít khoan dung với ứng dụng nặng {#os-is-less-forgiving-with-intensive-apps}
...
## Làm việc trên màn hình nhỏ {#working-on-small-screens}
...
## Bộ biến dạng Inflate hoặc Peak {#inflate-or-peak-deformer}
...
## Loại bỏ cục u hoặc 'mụn' sau thao tác voxel remesh {#remove-lumps-or-pimples-from-a-voxel-remesh-operation}
...
## Chiếu sáng ban ngày {#daylight-lighting}
