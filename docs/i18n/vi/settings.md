# ![](/icons/cog.webp) Cài đặt {#reset-to-default}
...
### Làm tối đối tượng không được chọn {#darken-unselected-objects}
...
## ![](/icons/cursor.webp) Con trỏ {#cursor}

### Hiện vòng tròn khi điêu khắc {#show-circle-while-sculpting}
Tiếp tục hiển thị bán kính cọ khi điêu khắc.

### Hiện chấm nhỏ {#show-small-dot}
Hiển thị một chấm ở tâm nét cọ khi điêu khắc, hoặc khi điểm xoay của camera thay đổi.

### Hiện dây ổn định {#show-rope-stabilizer}
...
### Kích thước/Biểu tượng/Vòng tròn {#indicator-shape}
...
## ![](/icons/culling.webp)Hai mặt {#two-sided}
Bật khả năng nhìn thấy các mặt đa giác từ cả hai phía.

### Tô màu mặt sau, Màu mặt sau {#backface-color}
Bật tô màu cho các mặt sau, và đặt màu tô.

## ![](/icons/outline.webp)Đường viền {#outline}
Bật đường viền quanh đối tượng đang hoạt động.

### Màu đường viền, Độ dày {#outline-color-thickness}
Đặt màu và độ dày của đường viền.


## ![](/icons/bang.webp) Tô sáng {#highlight}
...
## ![](/icons/snap_cube.webp) Khối lập phương căn chỉnh {#snap-cube}
...
### Vị trí {#stats-position}
Đặt góc mà phần thống kê sẽ nằm trong đó.

## Nguyên mẫu/Bộ lặp {#primitive-repeaters}
## Nhập số {#gizmo-input}
Cho phép nhập số khi chạm vào các widget của gizmo.

## Đa phân giải {#multires}
### Số lượng đỉnh tối đa {#multires-lowres-count}
...
### Ngưỡng độ phân giải thấp {#multires-lowres-threshold}
