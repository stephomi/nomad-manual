# ![](/icons/layer.webp) เลเยอร์ {#layers}
...
::: tip
ต่างจากซอฟต์แวร์ปั้นส่วนใหญ่ การเปลี่ยน topology ของเมชจะไม่ทำให้เลเยอร์หายไป คุณสามารถใช้ [Voxel Remesher](topology.md#voxel-remesher), [Multiresolution](topology.md#multires) หรือเครื่องมือ [Trim](tools.md#trim)/[Split](tools.md#split) ได้ แต่โปรดทราบว่าเมื่อใช้ [Voxel Remesher](topology.md#voxel-remesher) คุณภาพของเลเยอร์จะได้รับผลกระทบ
:::
...
#### ปัจจัยของแชนเนล {#channel-factors}
...
#### ![](/icons/preview.webp) แสดงตัวอย่าง {#preview}
...
#### ![](/icons/height.webp) ความหนา {#thickness}
...
#### ![](/icons/height.webp) วงขอบ (ด้านข้าง) {#edge-loop-side}
...
#### เก็บรายละเอียดจากเลเยอร์บนสุด {#keep-top-layers-details}
