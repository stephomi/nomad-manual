# ![](/icons/history.webp) Histórico {#history}
...
### Limite do histórico (Mb) {#history-limit-mb}
...
### Máximo de desfazer {#maximum-undoable}
Você pode controlar o número máximo de operações.

## Restaurar câmera {#restore-camera}
...
## Estatísticas de memória {#memory-stats}
