...
### Tempo limite do pop-up
Ativar tempo limite do pop-up.

### Descartar salvamento automático
...
### ![](/icons/cog.webp) Avançado
Exibe opções avançadas de importação:

### Projeto/ glTF / OBJ / STL / FBX
#### Manter topologia
...
### Projeto / glTF
#### Manter configurações da interface
