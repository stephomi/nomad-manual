# ![](/icons/manual.webp) Dicas {#tips}

[[toc]]

## Como começar um modelo {#how-to-start-a-model}
...
### Esculpir na esfera, multires {#sculpt-on-sphere-multires}
...
### Usar vários objetos {#use-multiple-objects}
...
### Usar outros apps {#use-other-apps}
...
### Usar os presets integrados {#use-the-built-in-presets}
...
### Usar modelos online {#use-online-models}
...
### Por que facegroups? {#why-facegroups}
...
### Criar e editar facegroups {#creating-and-editing-facegroups}
...
### Filtrar com outras ferramentas {#filter-with-other-tools}
...
### Relaxar e suavizar bordas de facegroup {#relax-and-smooth-facegroup-borders}
...
## Limitações em tablet/celular {#limitations-on-tabletmobile}
...
### Sem refrigeração ativa {#no-active-cooling}
...
### Memória limitada {#limited-memory}
...
### O sistema é menos tolerante com apps intensivos {#os-is-less-forgiving-with-intensive-apps}
...
## Trabalhando em telas pequenas {#working-on-small-screens}
...
## Deformador Inflate ou Peak {#inflate-or-peak-deformer}
...
## Remover caroços ou 'espinhas' de uma operação de voxel remesh {#remove-lumps-or-pimples-from-a-voxel-remesh-operation}
...
## Iluminação de luz do dia {#daylight-lighting}
