...
::: tip
В отличие от большинства программ для скульптинга, изменение топологии меша не удаляет слои. Можно использовать [Voxel Remesher](topology.md#voxel-remesher), [Multiresolution](topology.md#multiresolution) или инструменты [Trim](tools.md#trim)/[Split](tools.md#split), но имейте в виду, что при использовании [Voxel Remesher](topology.md#voxel-remesher) качество слоя ухудшится.
:::
