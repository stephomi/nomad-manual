# ![](/icons/paint.webp) Рисование {#painting}
...
### Вершинная покраска {#vertex-painting}
...
## Рисование штрихом {#stroke-painting}
...
### Интенсивность покраски {#paint-intensity}
...
## Пресеты материалов {#material-presets}
...
### Настройки трипланара {#triplanar-settings}
...
## Глобальный материал {#global-material}
