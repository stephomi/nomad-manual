# ![](/icons/sun.webp) Шейдинг {#shading}
...
### Показывать покраску {#show-paint}
...
### Обзор PBR и источников света {#pbr}
...
### Обзор типов источников света {#light-types-overview}
...
### ![](/icons/checked.webp) Флажок источников света {#lights-checkbox}

Переключает все прямые источники света в сцене.



### Добавить источник света {#add-light}
...
### ![](/icons/spotlight.webp) Значки {#icons}

Переключает отображение иконок источников света во вьюпорте.

### Панель инструментов света {#light-toolbar}
...
### Дополнительные настройки света {#light-extra-controls}
...
### Привязать к камере {#env-attached}
...
### Использовать глобальный Matcap {#matcap-global}
...
## ![](/icons/circle_fill.webp) Без освещения {#unlit}
...
## ![](/icons/cube.webp) ID объекта {#object-id}
...
### Рандомизировать ID {#object-random}

Генерирует новый набор случайных цветов. 

## ![](/icons/link.webp) ID инстанса {#instance-id}

То же, что и Object ID, но инстансы будут иметь одинаковый цвет. 

### Рандомизировать ID {#instance-random}
