...
| [Булево...](#boolean) | ![](/icons/bool_subtract_circle.webp) | Открыть меню [Булево](#boolean)                                                                                   |
...
| Разделить по группам граней | ![](/icons/group.webp)          | Если у объекта несколько групп граней, разбить сетку на отдельные объекты                                                                                            |
