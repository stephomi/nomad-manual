# ![](/icons/pencil.webp) Trait {#stroke}
...
#### Partager le rayon {#share-radius}
...
### ![](/icons/falloff.webp) Verrouillage + intensité {#lock-intensity}
...
### ![](/icons/radius.webp) Verrouillage + rayon (glisser) {#lock-radius-drag}
...
### Ajuster l’intensité de l’espacement {#adjust-spacing-intensity}
...
### Espacement du trait {#stroke-spacing}
...
### Stabilisateur corde lâche {#lazy-rope-stabilizer}
...
### Lissage du trait {#stroke-smoothing}
...
### Rayon d’accrochage {#snap-radius}
...
### ![](/icons/dice.webp) Aléatoire {#randomize}
...
### Décalage du trait {#stroke-offset}
...
### Inverser les pixels {#invert-pixels}
...
### Accumuler le trait {#accumulate-stroke}
...
### Uniquement les sommets face caméra {#front-facing-vertex-only}
...
### Autoriser la topologie dynamique {#allow-dynamic-topology}
...
### Topologie connectée {#connected-topology}
...
### Échantillonnage de zone {#area-sampling}
...
### Masquage de profondeur {#depth-masking}
...
#### Exemple : Peindre dans les cavités {#example-paint-in-cavities}
...
#### Exemple : Peindre sur les bosses {#example-paint-on-bumps}
...
### Pression - Rayon {#pressure-radius}
...
### Pression - Intensité {#pressure-intensity}
...
### Lissage de la pression {#pressure-smoothing}
