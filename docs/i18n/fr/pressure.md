...
Ce menu vous permet de personnaliser le comportement du stylet de la tablette, comme l’Apple Pencil ou le Samsung S Pen.
...
Dans ce cas, veillez à désactiver cette option.

Par défaut, cette option est activée sur iOS, mais désactivée pour Android.