...
### ![](/icons/stroke_dot.webp) Punkt
Dra som ett vanligt målarstreck. 
![](/videos/stroke_dot.mp4) 

### ![](/icons/stroke_roll.webp) Rulla
...
### ![](/icons/falloff.webp) Lås + intensitet 
...
### ![](/icons/radius.webp) Lås + radie (drag) 
...
### Justera intensitet efter mellanrum
...
### ![](/icons/silhouette.webp) Silhuett
