...
::: tip
与大多数雕刻软件不同，更改网格拓扑不会丢弃图层。你可以使用 [Voxel Remesher](topology.md#voxel-remesher)、[Multiresolution](topology.md#multiresolution) 或 [Trim](tools.md#trim)/[Split](tools.md#split) 工具，但请注意，当使用 [Voxel Remesher](topology.md#voxel-remesher) 时，图层质量会受到影响。
:::
