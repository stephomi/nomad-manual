...
## ![](/icons/culling.webp)双面
启用从两侧查看多边形面。

### 背面着色，背面颜色
启用背面着色以及背面着色的颜色。

## ![](/icons/outline.webp)轮廓线
为活动对象启用轮廓线。
