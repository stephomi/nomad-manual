# ![](/icons/interface.webp) Arayüz Menüsü 
...
#### ![](/icons/resize_bottom_right.webp) Ui Yeniden Boyutlandırma Köşesi
...
#### Renk aracı/Renk tabanı
Arayüzde kullanılan birincil renkler.

#### Şeffaf panel, Panel rengi, Bulanıklık gücü
...
### ![](/icons/fingerprint.webp) Geçmiş 2/3
...
### Pencil çift dokunma -> Bağlantılar 
...
## iOS ⌘ Klavye kısayolları görüntüleme
