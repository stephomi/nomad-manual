...
Bu menü, Apple Pencil veya Samsung S Pen gibi tablet kaleminin davranışını özelleştirmenizi sağlar.
...
Bu durumda, bu seçeneği devre dışı bıraktığınızdan emin olun.

Varsayılan olarak, bu seçenek iOS’ta etkin, Android’de ise devre dışıdır.