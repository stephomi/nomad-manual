# ![](/icons/manual.webp) İpuçları {#tips}

[[toc]]

## Bir modele nasıl başlanır {#how-to-start-a-model}
...
### Küre üzerinde yontma, çoklu çözünürlük {#sculpt-on-sphere-multires}
...
### Voksel yeniden örgüleme {#voxel-remesh}
...
### Birden çok nesne kullanma {#use-multiple-objects}
...
### Diğer uygulamaları kullanma {#use-other-apps}
...
### Yerleşik hazır ayarları kullanma {#use-the-built-in-presets}
...
### Çevrimiçi modelleri kullanma {#use-online-models}
...
### Neden yüz grupları? {#why-facegroups}
...
### Yüz grupları oluşturma ve düzenleme {#creating-and-editing-facegroups}
...
### Quad yeniden örgüleyici {#quad-remesher}
...
### Diğer araçlarla filtreleme {#filter-with-other-tools}
...
### Yüz grup sınırlarını rahatlatma ve düzleştirme {#relax-and-smooth-facegroup-borders}
...
## Tablet/mobilde sınırlamalar {#limitations-on-tabletmobile}
...
### Aktif soğutma yok {#no-active-cooling}
...
### İşletim sistemi yoğun uygulamalara karşı daha az hoşgörülü {#os-is-less-forgiving-with-intensive-apps}
...
## Küçük ekranlarda çalışma {#working-on-small-screens}
...
## Şişirme veya sivriltme şekil bozucu {#inflate-or-peak-deformer}
...
## Voksel yeniden örgüleme işleminden oluşan çıkıntıları veya 'sivilceleri' giderme {#remove-lumps-or-pimples-from-a-voxel-remesh-operation}
...
## Gün ışığı aydınlatması {#daylight-lighting}
