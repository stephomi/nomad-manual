...
::: tip
與多數雕刻軟體不同，更改網格拓樸不會丟失圖層。你可以使用 [Voxel Remesher](topology.md#voxel-remesher)、[Multiresolution](topology.md#multiresolution) 或 [Trim](tools.md#trim) / [Split](tools.md#split) 工具，但請注意，使用 [Voxel Remesher](topology.md#voxel-remesher) 時，圖層品質會受到影響。
:::
