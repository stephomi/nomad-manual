# ![](/icons/material.webp) 材质 {#material}
...
### ![](/icons/material_blending.webp) 透明混合 {#blending}
...
### ![](/icons/material_additive.webp) 叠加发光 {#additive}
...
### ![](/icons/material_dithering.webp) 抖动 {#dithering}
通过随机丢弃部分像素让对象半透明。

### ![](/icons/material_shadow_catcher.webp) 影子捕捉 {#shadow-catcher}
...
### ![](/icons/link.webp) 链接图标 {#chainlink-icon}
