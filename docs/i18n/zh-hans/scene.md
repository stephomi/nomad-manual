...
| 按面组分离         |            ![](/icons/group.webp)          | 如果一个物体包含多个面组，则将网格按面组拆分为多个物体。                                                                                                         |
