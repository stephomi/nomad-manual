# ![](/icons/manual.webp) Wskazówki {#tips}

[[toc]]

## Jak rozpocząć model {#how-to-start-a-model}
...
### Rzeźbienie na sferze, multires {#sculpt-on-sphere-multires}
...
### Przeremeszowanie wokselowe {#voxel-remesh}
...
### Używaj wielu obiektów {#use-multiple-objects}
...
### Używaj innych aplikacji {#use-other-apps}
...
### Używaj wbudowanych presetów {#use-the-built-in-presets}
...
### Używaj modeli z sieci {#use-online-models}
...
### Po co facegroups? {#why-facegroups}
...
### Tworzenie i edycja facegroups {#creating-and-editing-facegroups}
...
### Filtrowanie z innymi narzędziami {#filter-with-other-tools}
...
### Rozluźnianie i wygładzanie krawędzi facegroups {#relax-and-smooth-facegroup-borders}
...
## Ograniczenia na tabletach/urządzeniach mobilnych {#limitations-on-tabletmobile}
...
### Brak aktywnego chłodzenia {#no-active-cooling}
...
### System operacyjny mniej wyrozumiały dla wymagających aplikacji {#os-is-less-forgiving-with-intensive-apps}
...
## Praca na małych ekranach {#working-on-small-screens}
...
## Deformer Inflate lub Peak {#inflate-or-peak-deformer}
...
## Usuwanie grudek lub „pryszczy” po operacji voxel remesh {#remove-lumps-or-pimples-from-a-voxel-remesh-operation}
...
## Oświetlenie dzienne {#daylight-lighting}
