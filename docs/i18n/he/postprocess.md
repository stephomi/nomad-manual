# ![](/icons/postprocess.webp) עיבוד פוסט {#post-process}
...
### דגימת פריימים מרבית {#max-frame-sampling}
...
### מכפיל רזולוציה {#resolution-multiplier}
...
## תאורה גלובלית (SSGI) {#global-illumination-ssgi}
...
## האפלת סביבה (SSAO) {#ambient-occlusion-ssao}
...
## עומק שדה (DOF) {#depth-of-field-dof}
...
## סטייה כרומטית {#chromatic-aberration}
