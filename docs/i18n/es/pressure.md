...
Este menú te permite personalizar el comportamiento del lápiz de la tableta, como el Apple Pencil o el Samsung S Pen.
...
En ese caso, asegúrate de desactivar esta opción.

De forma predeterminada, esta opción está activada en iOS, pero desactivada para Android.
