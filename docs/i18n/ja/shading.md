# ![](/icons/sun.webp) シェーディング {#shading}
...
### ライトタイプの概要 {#light-types-overview}
...
### ![](/icons/checked.webp) ライトチェックボックス {#lights-checkbox}
...
### ![](/icons/spotlight.webp) アイコン {#icons}

ビューポート内のライトアイコンの表示を切り替えます。

### ライトツールバー {#light-toolbar}
...
### ライト追加コントロール {#light-extra-controls}
...
### グローバル Matcap を使用 {#matcap-global}
...
## ![](/icons/circle_fill.webp) アンリット {#unlit}
...
## ![](/icons/cube.webp) オブジェクト ID {#object-id}
...
### ID をランダム化 {#object-random}

新しいランダムカラーセットを生成します。 

## ![](/icons/link.webp) インスタンス ID {#instance-id}

Object ID と同様ですが、インスタンスは同じ色になります。 

### ID をランダム化 {#instance-random}
