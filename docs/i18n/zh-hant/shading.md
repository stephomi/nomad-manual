...
### ![](/icons/checked.webp) 燈光勾選框 {#lights-checkbox}
...
## ![](/icons/sphere_smooth.webp) Matcap 材質球 {#matcap}
...
## ![](/icons/circle_fill.webp) 無光照 {#unlit}
...
## ![](/icons/cube.webp) 物件 ID {#object-id}
...
### 隨機化 ID {#object-random}

產生一組新的隨機顏色。

## ![](/icons/link.webp) 實例 ID {#instance-id}

與 Object ID 類似，但同一個實例群組會使用相同顏色。

### 隨機化 ID {#instance-random}
