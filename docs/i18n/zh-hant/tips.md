...
## 如何開始建立模型 {#how-to-start-a-model}

3D 雕刻的初學者常會問，開始一個模型的最佳方式是什麼。並沒有唯一的最佳方式，不同的人有不同的偏好。以下是幾種較常見的做法。

### 在球體上雕刻，多重細分 {#sculpt-on-sphere-multires}
...
### 體素重新網格（Voxel remesh） {#voxel-remesh}
...
### 建立與編輯面群 {#creating-and-editing-facegroups}
...
### 作業系統對高強度應用程式較不寬容 {#os-is-less-forgiving-with-intensive-apps}
...
## 在小螢幕上作業 {#working-on-small-screens}
...
## 膨脹或尖峰變形器 {#inflate-or-peak-deformer}
...
## 移除體素重新網格後的腫塊或「粉刺」 {#remove-lumps-or-pimples-from-a-voxel-remesh-operation}
