# ![](/icons/faq.webp) 常見問題 {#faq}

[[toc]]

## 平台 {#platform}
### 我的專案在裝置裡的哪個位置？ {#locate}
...
### 我已經在一台裝置上購買 Nomad，可以在另一台裝置上使用嗎？ {#multi-devices}
只要是同一個商店、同一個帳號，就可以。
...
::: tip
如果你的行動裝置無法載入專案，請嘗試使用[桌面版](https://nomadsculpt.com)。你可以免費使用示範模式來匯入和匯出專案，但只有少量編輯工具可用。
