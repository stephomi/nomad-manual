...
### Tree view manipulation {#tree-view-manipulation}
...
| Separate Face Group |            ![](/icons/group.webp)          | If an object has multiple face groups, break the mesh into separate objects.                                                                                            |
...
### Voxel Merge Button {#voxel-merge-button}
...
### Primitive Toolbar {#primitive-toolbar}
...
### Hierarchy lines {#hierarchy-lines}
