...
| [Object Id](#object-id)     | Object ID                  | A random color per object, useful for painting applications.    |
| [Instance Id](#instance-id) | Instance ID                | A random color per instance, useful to identify shared meshes   |
