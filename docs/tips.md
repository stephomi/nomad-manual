...
## How to start a model {#how-to-start-a-model}
...
### Sculpt on sphere, multires {#sculpt-on-sphere-multires}
...
### Use multiple objects {#use-multiple-objects}
...
### Use the built in presets {#use-the-built-in-presets}
...
### Use online models {#use-online-models}
...
### Creating and editing facegroups {#creating-and-editing-facegroups}
...
### Filter with other tools {#filter-with-other-tools}
...
### Relax and smooth facegroup borders {#relax-and-smooth-facegroup-borders}
...
## Limitations on tablet/mobile {#limitations-on-tabletmobile}
...
### OS is less forgiving with intensive apps {#os-is-less-forgiving-with-intensive-apps}
...
## Working on small screens {#working-on-small-screens}
...
## Inflate or peak deformer {#inflate-or-peak-deformer}
...
## Remove lumps or 'pimples' from a voxel remesh operation {#remove-lumps-or-pimples-from-a-voxel-remesh-operation}
...
## Daylight lighting {#daylight-lighting}
